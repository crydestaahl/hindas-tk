  ...
  return (    
    ...
    <div className="pages-wrapper">
      <div style={{margin: '1rem 1.9rem'}}>
        ...
        <p>För att ansöka om medlemskap, vänligen fyll i formuläret nedan. För medlemsfrågor maila: <a href="mailto:medlem@hindasttennisklubb.net">medlem@hindastennisklubb.net</a></p>
      ...
      <div className="contact-form" >
          ...
          <input type="hidden" name="form-name" value="Medlemsskapsanmälan" />
              ...
              <label>
              <p style={{margin: '2rem 0'}}>Medlemstyp</p>
                <div className="radio">
                  <p>Vuxen</p>
              ...
              <label>
              <p style={{marginTop: '2rem'}}>Email</p>
